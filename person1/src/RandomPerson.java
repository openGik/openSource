...
public class RandomPerson {
    ...
    email[]={"anerodaq-5218@yopmail.com" , "tretik@yopmail.com", "8-495-495-48-48@mail.ru" , "gennadievich12365456@gmail.com"};
    private double zp[] ={90000 , 9000 , 83222 , 8888888 , 50000 , 63277 , 34000} ;
    private int age[] ={34,56,67,79,23,35,21,89,76,54,43,32,90 ,40 , 40 ,40} ;
    ...
    public Person[] create(int kol){
        ...
        for(int i = 0 ; i < kol ; i++){
            pers[i] = new Person(name[rand.nextInt(Math.abs(name.length-1))] ,
                    ...
                    email[rand.nextInt(Math.abs(email.length-1))] ,
